...
def metrics():
    ...
    metrics_text = """# HELP demo-v107_requests_total Total number of requests
# TYPE demo-v107_requests_total counter
demo-v107_requests_total {request_count}

# HELP demo-v107_response_time_seconds Average response time
# TYPE demo-v107_response_time_seconds gauge
demo-v107_response_time_seconds {avg_response_time:.3f}

# HELP demo-v107_active_connections Current active connections
# TYPE demo-v107_active_connections gauge
demo-v107_active_connections {active_connections}

# HELP demo-v107_memory_usage_bytes Memory usage in bytes
# TYPE demo-v107_memory_usage_bytes gauge
demo-v107_memory_usage_bytes {memory_usage}
""".format(
        SERVICE_NAME="demo-v107",
